...
func TestSplitInsertByWord(t *testing.T) {
	cases := map[string]struct {
		...
		`two lines`: {
			EditInsert{NewText: "123 456\n789", Position: Position{Line: 3, Character: 10}},
			[]Edit{
				EditInsert{NewText: "\n", Position: Position{Line: 3, Character: 10}},
				EditInsert{NewText: "123 ", Position: Position{Line: 3, Character: 10}},
				EditInsert{NewText: "456", Position: Position{Line: 3, Character: 14}},
				EditInsert{NewText: "789", Position: Position{Line: 4, Character: 0}},
			},
			false,
		},
		`two lines, line ends in space`: {
			EditInsert{NewText: "123 456  \n789", Position: Position{Line: 3, Character: 10}},
			[]Edit{
				EditInsert{NewText: "\n", Position: Position{Line: 3, Character: 10}},
				EditInsert{NewText: "123 ", Position: Position{Line: 3, Character: 10}},
				EditInsert{NewText: "456 ", Position: Position{Line: 3, Character: 14}},
				EditInsert{NewText: " ", Position: Position{Line: 3, Character: 18}},
				EditInsert{NewText: "789", Position: Position{Line: 4, Character: 0}},
			},
			false,
		},
		`consecutive \n`: {
			...
			[]Edit{
				...
				EditInsert{NewText: "\n", Position: Position{Line: 4, Character: 0}},
				EditInsert{NewText: "\n", Position: Position{Line: 5, Character: 0}},
				EditInsert{NewText: "789", Position: Position{Line: 6, Character: 0}},
			},
			false,
		},
		`multi line`: {
			...
			[]Edit{
				...
				EditInsert{NewText: "\n", Position: Position{Line: 4, Character: 0}},
				EditInsert{NewText: "789 ", Position: Position{Line: 4, Character: 0}},
				EditInsert{NewText: " ", Position: Position{Line: 4, Character: 4}},
				EditInsert{NewText: "\n", Position: Position{Line: 5, Character: 0}},
				EditInsert{NewText: " ", Position: Position{Line: 5, Character: 0}},
				EditInsert{NewText: "123 ", Position: Position{Line: 5, Character: 1}},
				EditInsert{NewText: " ", Position: Position{Line: 5, Character: 5}},
				EditInsert{NewText: "456", Position: Position{Line: 5, Character: 6}},
				EditInsert{NewText: "\n", Position: Position{Line: 6, Character: 0}},
				EditInsert{NewText: "789", Position: Position{Line: 7, Character: 0}},
			},
			false,
		},
	}
